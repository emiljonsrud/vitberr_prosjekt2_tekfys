...
fname = input("What file do you wish to simulate?\n> ")
simulation_data = np.load('fourier_data/' + fname + '.npz')
t, w = simulation_data['t'], simulation_data['w']
...
animate_deck_movement(t, theta_num_rk4, x_C_num_rk4 , y_C_num_rk4, stepsize=h_step, s_L=s_L_num,gjerde=True)
