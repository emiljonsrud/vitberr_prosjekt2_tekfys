...
w_num, t_num = simulation_data['w_num_2'], simulation_data['t_num_2']
y_num_rk4 = w_num[3]
...
h_step = 0.01
print(t_num)
animate_deck_movement(t_num, theta_num_rk4, x_C_num_rk4,
                      y_C_num_rk4, stepsize=h_step, s_L=s_L_num, gjerde=True)
